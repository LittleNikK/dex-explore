      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="text-center mb-10">
          <motion.p
            ...
            viewport={{ once: true }}
            className={`text-xs font-bold uppercase tracking-[0.2em] mb-2 ${isDark ? "text-zinc-500" : "text-zinc-400"
              }`}
          >
          ...
          <motion.h3
            ...
            className={`text-[24px] md:text-[28px] lg:text-[32px] font-bold font-sans tracking-[-0.04em] leading-[1.15] ${
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
          {chains.map((chain, index) => (
            <motion.div
              ...
              className={`glass rounded-2xl border p-5 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 relative group overflow-hidden ${isDark
            ...
            >
              ...
              {/* Chain Name */}
              <h4 className={`text-base font-bold font-sans tracking-[-0.04em] leading-[1.15] ${
              ...
              {/* Tagline */}
              <span className={`text-[10px] font-semibold uppercase mt-1 tracking-wider ${isDark ? "text-zinc-500 group-hover:text-zinc-300" : "text-zinc-400 group-hover:text-zinc-600"
                } transition-colors duration-300`}>
                {chain.tagline}
              </span>
            </motion.div>
